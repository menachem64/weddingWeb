...
const AboutSection = () => {
  ...
  return (
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 mb-10 md:mb-0">
        {/* <Image src="/images/about-image.png" width={500} height={500} /> */}
          ...
          className="hidden md:block w-[330px] h-[330px] md:w-[360] md:h-[360] xl:w-[400px] xl:h-[400px] border shadow-xl" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" alt="מיקום האולם בגוגל מפס"></iframe>
