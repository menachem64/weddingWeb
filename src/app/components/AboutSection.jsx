...
const TAB_DATA = [
  {
    ...
    content: (
      ...
      <div className="bg-white  text-center justify-end p-2 mx-[10px] shadow-2xl rounded-3xl transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
        <h1 className="text-3xl font-bold  text-slate-800 hover:text-slate-600  m-4">בביתר עלית רח' החוזה מלובלין</h1>
      </div>
    ),
  },
  {
    ...
    content: (
      ...
      <div className="bg-white  text-center justify-end p-2 mx-[10px] shadow-2xl rounded-3xl transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
       <h1 className="text-3xl font-bold bg-clip-text bg-gradient-to-r text-slate-800 hover:text-slate-600 m-4">על יד אוהל כ"ק אדמו"ר</h1>
    </div>
    ),
  },
  {
    ...
    content: (
      ...
      <div className="bg-white  text-center justify-end p-2 mx-[10px] shadow-2xl rounded-3xl transform transition-all duration-500 hover:scale-105 hover:shadow-xl">
      <h1 className="text-3xl font-bold bg-clip-text bg-gradient-to-r text-slate-800 hover:text-slate-600 m-4 ">בבית משפחת הרטמן</h1>
   </div>
    ),
  },
];
    ...
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        {/* <Image src="/images/about-image.png" width={500} height={500} /> */}
          ...
          className="hidden md:block w-[330px] h-[330px] md:w-[400px] md:h-[400px]" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <div className="mt-4 mb-7 md:mt-0 md:mb-0 flex flex-col h-full text-right">
          ...
          <p className="text-[#ADB7BE] mb-8 md:mb-0 text-base lg:text-lg">
                בעזרת השם ביום שלישי שהוכפל בו כי טוב י' תמוז ה'תשפ"ד
                נחגוג בגן האירועים בבית רבקה אשר בכפר חב"ד ב' את החתונה 
                ואנחנו ממש מצפים ומחכים לפגוש אתכם באירוע שלנו,
                מצורף כאן המיקום של האולם בגוגל מפות
          </p>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3383.7900025651984!2d34.86726042607474!3d31.993707723607045!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1502caa7c87cf23d%3A0x670cb3df33138ab0!2z15DXldec150g15DXmdeo15XXoteZ150g15HXmdeqINeo15HXp9eUINeb16TXqCDXl9eR15M!5e0!3m2!1siw!2sil!4v1715621747233!5m2!1siw!2sil"
            className="block md:hidden w-auto h-auto md:w-[400px] md:h-[400px]" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          <div className="flex flex-row justify-end text-sm text-center md:text-xl md:text-end mt-20 w-auto">
            <TabButton
          ...
          <div className="mt-8 ml-0 md:ml-10 text-right">
